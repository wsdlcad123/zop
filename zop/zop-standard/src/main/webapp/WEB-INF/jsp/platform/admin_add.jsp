...
<div class="wrap jj">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<zop:webinfo type="ctx"/>admin/admin.action?action=add">添加管理员</a></li>
    </ul>
        ...
        <form method="post" class="form-horizontal J_ajaxForm" action="<zop:webinfo type="ctx"/>admin/admin.action">
            ...
            <div class="table_list">
                <table cellpadding="2" cellspacing="2" width="100%">
                    ...
                    <tr>
                        <td width="180">密码:</td>
                        <td><input type="text" class="input" name="admin.password" value="${admin.password}"><span class="must_red">*</span></td>
                    </tr>
                    <tr>
                        <td>状态:</td>
                        <td><select name="admin.status" class="normal_select">
                            <option value="1">待审核</option>
                            <option value="0">己通过</option>
                        </select></td>
                    </tr>
                    <tr>
                        <td>角色:</td>
