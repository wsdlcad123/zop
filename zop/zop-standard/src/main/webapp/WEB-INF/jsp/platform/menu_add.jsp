...
<div class="wrap jj">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<zop:webinfo type="ctx"/>admin/menu.action?action=add">添加菜单</a></li>
    </ul>
        ...
        <form method="post" class="form-horizontal J_ajaxForm" action="<zop:webinfo type="ctx"/>admin/menu.action">
            ...
            <div class="table_list">
                <table cellpadding="2" cellspacing="2" width="100%">
                    ...
                    <tr>
                        <td>图标:</td>
                        <td><input type="text" class="input" name="menu.icon" id="icon" value="desktop"></td>
                    </tr>
                    <tr>
                        <td>状态:</td>
